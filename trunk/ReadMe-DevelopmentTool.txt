...
なでしこ２の開発は、オープンソースで行われています。

- オープンソースのC#開発環境 SharpDevelop(以下SD)
- Microsoft謹製の開発環境 Visual Studio(以下、VS)
- Mac OS XのMono開発環境 Xamarin Studio

とはいえ、開発自体は何で行っても大した差は出ないと思います。
